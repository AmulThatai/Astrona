...
; Generated by SHACHA on 14-02-2023 (UTC)
;
[Setup]
AppID={{a4b7abc1-ce4a-43cc-a498-dcca3e13d914}
AppName=ASCOM Astrona Dome Driver
AppVerName=ASCOM Astrona Dome Driver 0.0.1
AppVersion=0.0.1
AppPublisher=SHACHA <shauryachandra0406@gmail.com>
AppPublisherURL=mailto:shauryachandra0406@gmail.com
...
OutputDir="."
OutputBaseFilename="Astrona Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\Astrona"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\Astrona"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\thata\source\repos\Astrona\ASCOM.DeviceName.Astrona\bin\Release\ASCOM.Astrona.Dome.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\thata\source\repos\Astrona\ASCOM.DeviceName.Astrona\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Astrona.Dome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Astrona.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Astrona.Dome.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Astrona.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Astrona.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
